...
<html>
    ...
    <div class="form3">
        <h1>คำร้องขอลาป่วย/ลากิจ RO-16</h1>
        <div class="box1">
            ...
            <div class="donation-container">
                    ...
                    <div>
                        <input class="Group1" type="text" placeholder="สิ่งที่ส่งมาด้วย 1.">
                        <input class="Group1" type="text" placeholder="สิ่งที่ส่งมาด้วย 2.">
                    </div>
                ...
                <div>
                <select placeholder="มีความประสงค์">
                        <option value="" disabled selected>ความประสงค์</option>
                        <option value="sick">ลาป่วย</option>
                        <option value="work">ลากิจ</option>
                </select>
       
                <input  type="text" class="Group1" placeholder="ระยะเวลา" >
                </div>

                <div>
                        <input type="date" placeholder="จาก" class="date" name="from">

                        <input type="date" placeholder="ถึง" class="date" name="to" >
                        
                </div>
        

                <textarea placeholder="เนื่องจาก" rows="2" cols="50"></textarea>
                <a href="/">
